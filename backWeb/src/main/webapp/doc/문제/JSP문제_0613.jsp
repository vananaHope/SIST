...
반복문에서 증가 처리하는 부분과 %로 INDEX 조건에 따라 나머지 연산자를 처리하는 경우가 많다.
...
입력을 해서 ==> DB확인 ==> 권한 내용에 따라 메뉴 접근 처리
ex) 로그인 아이디/패스워드로 인증을 받아, DB에 권한을 가져와서 이 권한에 따라 특정 메뉴를 보이게 하거나
	보이지 않게 처리
