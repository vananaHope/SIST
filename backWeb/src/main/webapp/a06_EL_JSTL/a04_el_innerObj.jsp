...
3. 기본 객체들
	1) scope관련 : pageScope, requestScope, sessionScope,
		...
		ex) pageContext.setAttribute("name","홍길동")
			...
			${fruit} : 위 4개 중 하나의 범위 상관 없이 출력된다
	...
	4) paramValues : 요청 파라미터의 <파라미터이름, 값 배열>매핑을
		저장한 Map객체
	...
	8) initParam : 초기화 파라미터의 <이름, 값> 매핑을 저장한
		Map객체	
...
<body>
    <div class="container mt-3">
		...
		계산 클릭시 아래에 점수와 총점,평균을 el로 출력되게 하세요
		 --%>
		 <form action="" method="post">
         	<div class="mb-3 mt-3">
            ...
            <input type="number" class="form-control" 
      	     id="point" placeholder="국어점수 입력" name="point">
         	</div>
         	<div class="mb-3 mt-3">
            <label for="eng">영어:</label>
            <input type="number" class="form-control" 
      	     id="point" placeholder="영어점수 입력" name="point">
         	</div>
         	<div class="mb-3 mt-3">
            <label for="math">수학:</label>
            <input type="number" class="form-control" 
      	     id="point" placeholder="수학점수 입력" name="point">
         	</div>
