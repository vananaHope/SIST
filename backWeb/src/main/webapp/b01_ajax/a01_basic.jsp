...
--------------------------------------------------------------				
	5) 비동기식일 때, 처리하는 이벤트 및 이벤트 핸들러 함수
		위 3) 항목까지 처리하고, 결과를 받은 xhr.responseText을 이벤트로
		처리한다.
