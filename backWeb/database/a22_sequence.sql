/*
 # primary key의 데이터 입력 시 사용하는 sequence 객체
 ...
 2. 기본 형식
 	1) 생성
 	 create sequence 시퀀스명
 	 	...
 	 	minvalue 최소값
 	 	maxvalue 최대값
 	 	cycle | nocycle 최소값/최대값이 있을 때 반복 여부 설정	 
  		cache n | nocache 속도 개선을 위한 메모리 캐시 시퀀스 설정
...
-- 데이터 입력 시 사용
INSERT INTO EMPLOYEES02 e values(seq01.nextval);
SELECT * FROM EMPLOYEES02 e ;
