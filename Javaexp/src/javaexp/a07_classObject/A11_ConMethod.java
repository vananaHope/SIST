...
public class A11_ConMethod {
	...
	public static void main(String[] args) {
		...
		Calculator02 cal01 = new Calculator02(4,5);
		
		System.out.println(" = "+cal01.plus());
		System.out.println(" = "+cal01.minus());
		System.out.println(" = "+cal01.multi());
		System.out.println(" = "+cal01.divide());
	}
...
//  출력 @@ + @@
// 	리턴값을 연산결과 리턴하게 처리하세요 외부에서 리턴받아 연산 결과를 출력
...
class Calculator02 {
	...
	double divide() {
		...
		// 3항 연산자로 처리해야 한다.
		double sum = num02==0?0:num01/(double)num02;
		System.out.print(num01+" ÷ "+num02);
		return sum;
	}
