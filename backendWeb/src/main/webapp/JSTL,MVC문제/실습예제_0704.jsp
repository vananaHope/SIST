...
<body>
	<jsp:useBean id="m1" class="backendWeb.z01_vo.Member"/>
	<jsp:setProperty property="name" name="m1" value="오길동"/>
    <h3>회원이름1:<jsp:getProperty property="name" name="m1"/></h3>
    <h3>회원이름2:${m1.name}</h3>
    
    <jsp:useBean id="gugu" class="backendWeb.z01_vo.Gugu"/>
    ...
    <jsp:useBean id="dept" class="backendWeb.z01_vo.Department"/>
    <jsp:setProperty property="*" name="dept"/>
    <jsp:useBean id="daoDept" class="backendWeb.a01_dao.A04_PreparedDao"/>
